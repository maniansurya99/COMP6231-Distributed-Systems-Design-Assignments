...
#define NUM_ROWS_A 8 //rows of input [A]
#define NUM_COLUMNS_A 32 //columns of input [A]
#define NUM_ROWS_B 32 //rows of input [B]
#define NUM_COLUMNS_B 8 //columns of input [B]
